<template>
    ...
    <div class="our-team text-center">
        <div class="container">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<br />Quae quasi magni quaerat, quam repudiandae
                amet.</p>
            <div class="team row justify-content-center">
                <div class="person col-12 col-sm-6 col-md-3">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod maiores voluptas beatae reiciendis
                        accusantium expedita.</p>
                </div>
                <div class="person col-12 col-sm-6 col-md-3">
